...
values ('Antidote', 'Healing Items', 10000, 'Removes Poison effects from a Pokémon', '/images/Antidote.webp' ),
      ...
      ('Friendship Ribbon', 'Evolution Items', 2000000, 'Evolves Pokémon which require Happiness' , '/images/Ribbon.webp' ),
      ('Leaf Stone', 'Evolution Items', 1000000, 'Evolves many different Pokémon' , '/images/LeafStone.webp'),
      ('Moon Stone', 'Evolution Items', 1000000, 'Evolves many different Pokémon', '/images/MoonStone.webp' ),
      ('Sinnoh Stone', 'Evolution Items', 1500000, 'Evolves many different Pokémon', '/images/SinnohStone.webp' ),
      ('Thunder Stone', 'Evolution Items', 1000000, 'Evolves many different Pokémon' , '/images/ThunderStone.webp' ),
      ('Water Stone', 'Evolution Items', 1000000, 'Evolves many different Pokémon' , '/images/WaterStone.webp' ),
